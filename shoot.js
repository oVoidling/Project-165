AFRAME.registerComponent("bullets", {
  ...
  shootBullet: function () {
    window.addEventListener("keydown", (e) => {
      if (e.key === "z") {
        ...
        bullet.setAttribute("position", {x: pos.x,y: pos.y+1.6,z: pos.z-0.08})
  ...
  removeBullet: function (e) {
    ...
    var colorNo = parseInt(Math.random() * 8 + 1)
    paint.setAttribute("material", {opacity: 1,transparent: true,src: "./images/paint splash-0" + colorNo + ".png"})
